...
RSpec.describe OmniAuth::Strategies::LinkedIn do
  ...
  describe '#client' do
    ...
    it 'has correct authorize url' do
      subject.client.options[:authorize_url].should eq('https://www.linkedin.com/oauth/v2/authorization?response_type=code')
    end

    it 'has correct token url' do
      subject.client.options[:token_url].should eq('https://www.linkedin.com/oauth/v2/accessToken')
    end
